...
from config_analisis.diccionario_codigos import COD_DEPT_MUN as CDM
from config_analisis.errores_cols_salida import ERR_COLS
from config_analisis.codigos_invalidos import CODS_INV
from config_analisis.mapeo_nombres import MAPPER
...
def analyzer():
    ...
    if err_df.empty and err_df_2.empty:
        ...
        temp_df.to_excel('ERROR_' + file_name, index=False)
    progress_bar.destroy()
    root.update()
